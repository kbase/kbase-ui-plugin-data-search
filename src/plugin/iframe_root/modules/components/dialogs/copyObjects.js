define([
    ...
    // 'select2'
], function (ko, reg, gen, SubscriptionManager, html, htmlBuilders, BS, ui, Data, NarrativeSelectorComponent) {
    'use strict';
    ...
    function viewModel(params, componentInfo) {
        ...
        function viewObject(ref) {
            data.getObjectInfo(ref).then(function (objectInfo) {
        ...
        data.getObjectsInfo(objectsToCopy).then(function (objectsInfo) {
                        ...
                        [
                            gen.ifnot(
                                ...
                                table(
                                    ...
                                    [
                                        thead([tr([th('type'), th('object name'), th('remove')])]),
                                        tbody(
                                            {
                                                dataBind: {
                                                ...
                                                tr(
                                                    {
                                                        ...
                                                        dataBind: {
                                                            ...
                                                            class:
                                                                'selected() ? "' + styles.scopes.selected + '" : false'
                                                        }
                                                    },
                                                    [
                                                        td({
                                                            ...
                                                            button(
                                                                {
                                                                    ...
                                                                    dataBind: {
                                                                        ...
                                                                        enable:
                                                                            '$component.selectedObjects().length > 1',
                                                                        attr: {
                                                                            title:
                                                                                '$component.selectedObjects().length > 1 ? $component.messages.removeObjectFromList : $component.messages.cannotRemoveLastObjectFromList'
                                                                        }
                                                                    }
                                                                },
                                                                span({
    ...
    function buildIntro() {
        return p([
            ...
            b('new Narrative'),
            ', which will be created on the fly, or an ',
    ...
    function buildInProgressPanel() {
        return [
            ...
            BS.buildPanel({
                type: 'info',
                title: 'In Progress',
                body: div([htmlBuilders.loading('Copying')])
            }),
            '<!-- /ko -->'
        ];
    }
                ...
                body: div(
                    ...
                    [
                        ...
                        div(
                            ...
                            [buildSuccessPanel(), buildInProgressPanel(), buildErrorPanel()]
                        )
                    ]
                ),
                buttons: [

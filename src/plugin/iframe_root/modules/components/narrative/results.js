define([
    ...
    function buildRow() {
        return div(
            ...
            [buildNarrativeRow(), buildViewRow()]
        );
    }
        ...
        return div(
            ...
            [
                ...
                div(
                    ...
                    ['<!-- ko if: isNarrative -->', buildNarrativeOptionsColumn(), '<!-- /ko -->']
                )
            ]
        );
    }
    ...
    function buildNoSearch() {
        return div(
            ...
            [
                ...
                p(
                    'This will search both text and data in all your Narratives, Narratives shared with you (Private), and Narratives shared with all KBase users (Public).'
                ),
                hr({
                    style: {
                        width: '50%'

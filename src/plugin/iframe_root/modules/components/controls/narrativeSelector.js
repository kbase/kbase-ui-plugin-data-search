define([
    ...
    'kb_lib/htmlBuilders',
    '../../lib/data'
], function (ko, reg, gen, SubscriptionManager, html, htmlBuilders, Data) {
    'use strict';
    ...
    function viewModel(params, componentInfo) {
        ...
        const narrativesFiltered = ko.pureComputed(function () {
            ...
            if (!search) {
                ...
                nar = narratives().filter(function (narrative) {
                    return Object.keys(narrative.searchable).some(function (key) {
                        return narrative.searchable[key].indexOf(searchString) >= 0;
                    });
                });
                                ...
                                div(
                                    ...
                                    [
                                        ...
                                        span({
                                            ...
                                            dataBind: {
                                                class:
                                                    'sortDirection() === "ascending" ? "fa-sort-asc" : "fa-sort-desc"',
                                                click: 'doToggleSort'
                                            }
                                        }),
                                        ...
                                        [
                                            div(
                                                ...
                                                [
                                                    'Showing ',
                                                    gen.if(
                                                        'narrativesFiltered().length === totalCount()',
                                                        span([
                                                            'all ',
                                                            span({
                                                                dataBind: {
                                        ...
                                        div(
                                            {
                                                ...
                                                dataBind: {
                                                    ...
                                                    class:
                                                        ...
                                                        styles.classes.hoverRow +
                                                        '" : ""), ($data && $data.selected && selected() ? "' +
                                                        styles.classes.selectedRow +
                                                        '" : "")].join(" ")',
                                                    event: {
                            ...
                            div(
                                {
                                    ...
                                    dataBind: {
                                        if:
                                            '!tooManyResults() && narrativesFiltered().length === 0 && inputValue() && inputValue().length < 2'
                                    }
                                },
                                [

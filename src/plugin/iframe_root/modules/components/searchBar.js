define([
    ...
    'kb_lib/html',
    './searchHelp'
], function ($, ko, reg, SubscriptionManager, html, SearchHelpComponent) {
    'use strict';
                    ...
                    div(
                        ...
                        [
                            input({
                                class: 'form-control',
                                title:
                                    'Enter one or more search terms here, the press Enter/Return or click the search icon',
                                dataBind: {
                    ...
                    div(
                        {
                            ...
                            dataBind: {
                                ...
                                css:
                                    'searchControlValue() ? "' +
                                    styles.classes.addonButton +
                                    '" : "' +
                                    styles.classes.addonButtonDisabled +
                                    '"'
                            }
                        },
                        span({

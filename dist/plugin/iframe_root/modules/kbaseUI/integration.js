...
constructor({rootWindow:e}){
this.rootWindow=e,this.container=e.document.body,this.hostParams=this.getParamsFromIFrame(),
this.hostChannelId=this.hostParams.channelId,
this.pluginParams=this.hostParams.params,
this.authorized=null,this.navigationListeners=[],
this.navigationQueue=[],this.channel=new t.BidirectionalWindowChannel({
on:this.rootWindow,host:document.location.origin,to:this.hostChannelId
}),this.runtime=null}getParamsFromIFrame(){
...
this.channel.start(),this.channel.on("start",a=>{
const{token:s,username:i,config:h,realname:r,email:o}=a;this.authorization=s?{
token:s,username:i,realname:r,email:o
}:null,this.token=s,this.username=i,this.config=h,
this.authorized=!!s,this.runtime=new e({config:h,token:s,username:i

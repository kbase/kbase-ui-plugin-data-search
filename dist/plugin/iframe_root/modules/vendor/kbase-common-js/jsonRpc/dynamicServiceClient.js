...
}(r)?function(t){return new e((function(e,r){var i=(new Date).getTime()
;!function c(){window.setTimeout((function(){if(!n[t.id])return a({id:t.id,
fetch:t.fetch}).then((function(){e(n[t.id])})).catch((function(e){r(e)}))
;if(t.reserved){var o=(new Date).getTime()-i
;o>u?(delete n[t.id],r(new Error("Timedout waiting for cache item to become available; timeout "+u+", waited "+o))):c()

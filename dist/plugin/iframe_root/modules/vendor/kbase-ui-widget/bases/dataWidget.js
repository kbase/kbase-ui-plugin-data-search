...
var u,c,i,f,l,s=[],d=[],h=r.make(),y=a.runtime,m=r.make(),p=a.defaults,g={}
;if(T("new"),!y)throw D({type:"ArgumentError",reason:"RuntimeMissing",
...
s.hasOwnProperty(n)||(s[n]=[]),s[n].push(t)}function b(n){
return!!s.hasOwnProperty(n)}function E(n){return b(n)?s[n]:[]}function k(n,t){
h.set(n,t)}function w(n,t){return h.get(n,t)}function O(){return h.setClean()}
function T(n){status=n}f=a.class,l=a.icon;var j,C={};function P(n){var t=S(n)
...
if(h.isDirty())if(O(),"error"!==status){var t=E("render");if(t.length>1)throw{
type:"HookError",reason:"TooManyHooks",
message:"The render hook only supports 0 or 1 hooks"}
;if(0!==t.length)return n.try((function(){return t[0].call(i)
})).then((function(n){if(n)if("object"==typeof n){
if(n.content&&L("body",n.content),n.after)try{n.after.call(i)}catch(t){
...
id:o.genId(),content:n({class:"panel panel-default "+f},[n({
class:"panel-heading"},[n({class:"kb-row"},[n({class:"-col -span-8"},[t({
class:"fa pull-left fa-"+l,style:{fontSize:"150%",paddingRight:"10px"}}),t({
...
})),a&&a.events&&a.events.forEach((function(n){M(n)})),i=Object.freeze({
recv:function(n,t,e){d.push(y.recv(n,t,e))},send:function(n,t,e){y.send(n,t,e)},
getConfig:function(n,t){return y.getConfig(n,t)},hasConfig:function(n){
return y.hasConfig(n)},getState:w,setState:k,hasState:function(n){
return h.has(n)},getParam:function(n,t){return m.get(n,t||p[n])},
...
addDomEvent:M,setTitle:z,runtime:y}),Object.freeze({on:function(n,e){
...
return n.try((function(){return e.call(i,t)}))}));return n.all(e)}}))},
...
return n.try((function(){return t.call(i,c)}))}))
;return n.all(r).then((function(){return null}))}if(b("layout")){
var o=E("layout")[0];return n.try((function(){return o.call(i)
})).then((function(n){
...
return a.title&&z(a.title),d.push(y.recv("app","heartbeat",(function(){
...
if(d.forEach((function(n){n&&y.drop(n)})),b("stop")){
var t=E("stop").map((function(t){return n.try((function(){t.call(i)}))}))
;return n.all(t)}}))},detach:function(){return n.try((function(){
if(u&&u.removeChild(c),c=null,u=null,b("detach")){
var t=E("detach").map((function(t){return n.try((function(){return t.call(i)}))
...
return n.try((function(){return t.call(i)}))}));return n.all(t)}}))}})}

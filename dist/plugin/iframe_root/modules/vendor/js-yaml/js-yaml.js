...
return g(e)&&65279!==e&&44!==e&&91!==e&&93!==e&&123!==e&&125!==e&&58!==e&&35!==e
}function x(e){return/^\n* /.test(e)}function v(e,t,n,i,r){
var o,a,s=!1,c=!1,u=-1!==i,l=-1,p=function(e){
return g(e)&&65279!==e&&!m(e)&&45!==e&&63!==e&&58!==e&&44!==e&&91!==e&&93!==e&&123!==e&&125!==e&&35!==e&&38!==e&&42!==e&&33!==e&&124!==e&&62!==e&&39!==e&&34!==e&&37!==e&&64!==e&&96!==e
}(e.charCodeAt(0))&&!m(e.charCodeAt(e.length-1));if(t)for(o=0;o<e.length;o++){
if(!g(a=e.charCodeAt(o)))return 5;p=p&&y(a)}else{for(o=0;o<e.length;o++){
if(10===(a=e.charCodeAt(o)))s=!0,
u&&(c=c||o-l-1>i&&" "!==e[l+1],l=o);else if(!g(a))return 5;p=p&&y(a)}
c=c||u&&o-l-1>i&&" "!==e[l+1]}return s||c?n>9&&x(e)?5:c?4:3:p&&!r(e)?1:2}
...
o++):(i=u[t],r+=!i&&g(t)?e[o]:i||p(t));return r}(t)+'"';default:
...
0!==i&&(s+=", "),a=n[o=l[i]],
j(e,t,o,!1,!1)&&(e.dump.length>1024&&(s+="? "),s+=e.dump+(e.condenseFlow?'"':"")+":"+(e.condenseFlow?"":" "),
...
for(l=0,p=e.implicitTypes.length;l<p;l+=1)if((f=e.implicitTypes[l]).resolve(e.result)){
...
65279===e.charCodeAt(0)&&(e=e.slice(1)));var n=new I(e,t)
...
function $(e,t,n){var i,r,o=K(e,n);if("function"!=typeof t)return o
;for(i=0,r=o.length;i<r;i+=1)t(o[i])}function H(e,t){var n=K(e,t)
...
if("function"!=typeof t)return $(e,i.extend({schema:a},n));$(e,t,i.extend({
